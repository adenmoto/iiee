...
@section('content')   
    ...
    <div class="container animated fadeIn">
      ...
      <div class="row">
        ...
        <div class="col-lg-12"  style="background-color: rgb(255,255,255,.4)">
          <h2>About IEEE</h2>
          ...
          <p>IIEE is committed to <br>(1) upgrade the professional credentials of its members through the Continuing Professional Development (CPD) programs. <br>(2) enhance their social standing through the promotion of high ideals of integrity and ethics. <br>(3) facilitate advancement of technology transfer through carefully conceived educational and training programs.<br>(4) provide opportunity for regular interaction among electrical practitioners.</p>
        </div>
      </div>
    @endsection
